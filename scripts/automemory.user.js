...
(function () {
    ...
    const AI_SUMMARY_SIDEBAR_ICON_SVG = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="var(--icon_secondary)" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" class="crack-ext-sidebar-ai-icon" aria-hidden="true"><path d="M7 4.5h10a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-11a2 2 0 0 1 2-2Z"/><path d="M8.5 9h7M8.5 12.5h7M8.5 16h4.5"/></svg>';
...
async function fetchRecentMessages(limit) {
    ...
    function updateReasoningOptions(provider, model) {
        ...
        if (!options.some(function(item) { return item.v === saved; })) {
            saved = 'auto';
...
#crack-ext-ai-sidebar-menu .crack-ext-sidebar-ai-icon{display:block;width:24px;height:24px;flex:0 0 24px;opacity:1;fill:none!important;stroke:var(--icon_secondary)!important}
#crack-ext-ai-sidebar-menu .crack-ext-sidebar-ai-icon path{fill:none!important;stroke:var(--icon_secondary)!important}
